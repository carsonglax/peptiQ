...
const peptides = [
  {
    ...
    description:
      "BPC-157 is a synthetic peptide composed of 15 amino acids derived from a 'body protective compound' isolated from human gastric juice. Preclinical research (mostly in rodents) has explored its role in accelerating soft-tissue healing — tendons, ligaments, muscle, and the GI lining — and in modulating angiogenesis and nitric-oxide signaling.",
    mechanism:
      "Appears to upregulate growth-factor receptors (e.g., VEGFR2), enhance nitric-oxide pathways, and promote fibroblast migration and angiogenesis at injury sites.",
    halfLife: "Short systemic half-life (minutes); local effects studied at injury sites.",
    studied: [
    ...
    dosing:
      "Research literature reports oral and injectable use in animals at microgram-per-kg ranges. There is no validated human dose.",
    status:
      "Not FDA-approved. Placed on FDA's Section 503A bulks 'do not compound' category 2 list in 2023.",
    references:
      "Sikiric et al. (multiple preclinical reviews); FDA 503A Bulks List."
  },
  {
    name: "TB-500",
    ...
    description:
      "TB-500 is a synthetic version of the active region of Thymosin Beta-4, a naturally occurring peptide involved in actin regulation and cell migration. It has been investigated in preclinical models for wound healing, cardiac repair after ischemia, and corneal injury.",
    mechanism:
      "Binds G-actin and influences cytoskeletal dynamics, enabling cell migration to sites of injury; also implicated in angiogenesis and anti-inflammatory signaling.",
    halfLife: "Estimated several hours; tissue-binding may extend local action.",
    studied: [
    ...
    risks: [
      "Banned by WADA for athletes (S2 class)",
      "No approved human therapeutic use",
      "Concerns about pro-angiogenic effects in undiagnosed tumors",
      "Long-term human safety data are absent"
    ],
    dosing:
      "Animal studies use mg-range injections, often weekly. No validated human protocol exists.",
  ...
  },
  {
    ...
    description:
      "GHK is a naturally occurring tripeptide (glycyl-L-histidyl-L-lysine) that binds copper(II) with high affinity. The complex GHK-Cu has been studied for decades in dermatology and wound healing, and is widely used in cosmetic skincare formulations.",
    mechanism:
      "Acts as a copper carrier, modulating expression of genes involved in extracellular matrix remodeling, antioxidant defense, and DNA repair; stimulates fibroblast collagen and elastin production.",
    halfLife: "Topical action localized; systemic kinetics depend on route.",
    studied: [
      "Improvement of skin firmness and fine lines",
    ...
    risks: [
      "Possible local irritation or contact sensitivity",
      "Injectable use is not FDA-approved",
      "Limited large-scale human clinical trials"
    ],
    dosing: "Cosmetic creams typically 0.05–2%. Injectable use is research-only.",
  ...
  },
  {
    ...
    description:
      "KPV is the C-terminal tripeptide of alpha-melanocyte stimulating hormone (α-MSH). Unlike α-MSH itself, it lacks pigmentation effects but retains anti-inflammatory activity, with research focused on inflammatory bowel disease and dermatologic inflammation.",
    mechanism:
      "Reduces NF-κB signaling and pro-inflammatory cytokine release; may act on melanocortin receptors and intracellular targets within immune cells.",
    halfLife: "Short; oral and topical formulations being explored.",
    studied: [
    ...
    risks: [
      ...
      "Quality varies widely from research suppliers"
    ],
    dosing: "Oral microgram–milligram dosing studied in preclinical work.",
  ...
  },
  {
    ...
    description:
      "Ipamorelin is a synthetic pentapeptide that selectively stimulates the release of growth hormone (GH) by acting on the ghrelin/GHS-R1a receptor in the pituitary. Compared with older GHRPs, it produces minimal cortisol or prolactin elevation in studies.",
    mechanism:
      "Agonist at the ghrelin receptor (GHS-R1a) in the anterior pituitary, triggering GH release without strongly activating the HPA axis.",
    halfLife: "Approximately 2 hours.",
    studied: [
      "Pulsatile GH release",
      "Indirect IGF-1 elevation",
      "Possible support of body composition changes when paired with GHRH analogs"
    ],
    risks: [
    ...
    dosing: "Research literature describes 100–300 mcg subcutaneous, often paired with CJC-1295.",
  ...
  },
  {
    ...
    description:
      "Tesamorelin is a stabilized analog of growth-hormone-releasing hormone (GHRH) with an added trans-3-hexenoic acid group, improving stability. It is FDA-approved (as Egrifta) for the reduction of excess visceral abdominal fat in HIV-infected patients with lipodystrophy.",
    mechanism:
      "Binds GHRH receptors in the anterior pituitary, stimulating endogenous GH and IGF-1 release in a physiologic, pulsatile pattern.",
    ...
    dosing: "Approved label dosing is 2 mg subcutaneous daily for HIV-lipodystrophy.",
  ...
  },
  {
    ...
    description:
      "CJC-1295 is a modified GHRH analog. The 'DAC' (drug affinity complex) version contains a maleimide group that binds albumin, dramatically extending half-life and producing prolonged GH/IGF-1 elevation. The non-DAC form (often called Mod-GRF 1-29) is short-acting.",
    mechanism:
      "GHRH receptor agonist in the pituitary, stimulating GH release; albumin binding (DAC) prolongs systemic exposure.",
    halfLife: "Mod-GRF 1-29: ~30 min. CJC-1295 with DAC: roughly 6–8 days.",
    studied: [
    ...
    dosing: "Research protocols often describe 1–2 mg weekly (DAC) subcutaneously.",
  ...
  },
  {
    ...
    description:
      "Sermorelin is the first 29 amino acids of human GHRH, the smallest fragment retaining full activity. It was previously FDA-approved (as Geref) for GH deficiency assessment and stimulation of endogenous GH; the brand was discontinued, though compounded versions remain in use.",
    mechanism:
      "GHRH receptor agonist; promotes physiologic, pulsatile GH release from the anterior pituitary.",
    halfLife: "Roughly 10–20 minutes.",
    studied: [
      "Stimulation of GH and IGF-1 in deficient adults and children",
      "Sleep architecture changes",
      "Possible body composition effects in small studies"
    ],
    risks: [
    ...
    dosing: "Historical labeled use at 0.2–0.3 mg subcutaneously at bedtime.",
  ...
  },
  {
    ...
    description:
      "Hexarelin is a synthetic hexapeptide growth-hormone-releasing peptide. It has been studied in humans for diagnostic GH testing and in preclinical models for cardioprotective effects, possibly via the CD36 receptor in addition to the ghrelin receptor.",
    mechanism:
      "Agonist at ghrelin (GHS-R1a) receptors; also binds CD36, implicated in cardiovascular signaling.",
    ...
    dosing: "Research literature uses 100 mcg subcutaneous, 1–2x daily.",
  ...
  },
  {
    ...
    description:
      "MK-677 (Ibutamoren) is a non-peptide, orally bioavailable growth-hormone secretagogue developed by Merck. It mimics ghrelin's action at GHS-R1a, producing sustained increases in GH and IGF-1. Although not a peptide, it is often discussed alongside GH peptides.",
    mechanism:
      "Small-molecule agonist at the ghrelin receptor; also stimulates appetite via central pathways.",
    halfLife: "Approximately 4–6 hours; once-daily dosing produces 24-hour effects.",
    studied: [
    ...
    dosing: "Research and SARM-market use commonly cites 10–25 mg orally once daily.",
  ...
  },
  {
    ...
    description:
      "Semaglutide is a long-acting glucagon-like peptide-1 (GLP-1) receptor agonist. It is FDA-approved for type 2 diabetes (Ozempic, Rybelsus) and chronic weight management (Wegovy). It is one of the most studied GLP-1 analogs in modern medicine.",
    mechanism:
      "Activates GLP-1 receptors in the pancreas (enhancing glucose-dependent insulin secretion), brain (suppressing appetite), and GI tract (slowing gastric emptying).",
    halfLife: "Approximately 7 days; once-weekly subcutaneous dosing.",
    studied: [
      "A1c reduction in type 2 diabetes",
      "Mean ~15% body weight reduction in obesity trials",
    ...
    dosing: "Wegovy titrated to 2.4 mg weekly; Ozempic typically 0.5–2.0 mg weekly.",
    status: "FDA-approved.",
  ...
  },
  {
    ...
    description:
      "Tirzepatide is a once-weekly synthetic peptide that activates both GIP and GLP-1 receptors. The dual mechanism produces larger weight loss than GLP-1 mono-agonists in head-to-head trials, with comparable glycemic control.",
    mechanism:
      "Dual agonist at the GIP and GLP-1 receptors, enhancing insulin secretion, suppressing glucagon, slowing gastric emptying, and reducing appetite.",
    halfLife: "Approximately 5 days.",
    studied: [
      "A1c reductions exceeding many comparators (SURPASS)",
      "Mean ~20% body weight reduction in obesity (SURMOUNT)",
    ...
    dosing: "Titrated up to 5–15 mg weekly subcutaneously.",
    status: "FDA-approved.",
  ...
  },
  {
    ...
    description:
      "Retatrutide is an investigational once-weekly peptide that activates three receptors: GLP-1, GIP, and the glucagon receptor. Phase 2 data in obesity reported mean weight reductions over 24% at 48 weeks at the highest dose — the largest seen for any pharmacotherapy to date.",
    mechanism:
      "Triple receptor agonist: GLP-1 (insulin/satiety), GIP (insulin/adipose), and glucagon (energy expenditure and hepatic lipid mobilization).",
    ...
    dosing: "Trial doses 1–12 mg weekly subcutaneously, with stepwise titration.",
  ...
  },
  {
    ...
    description:
      "AOD-9604 is a synthetic peptide modeled on the C-terminal fragment of human growth hormone (residues 176–191). It was developed in the late 1990s with the goal of producing GH's lipolytic effects without its growth-promoting or insulin-resistance effects.",
    mechanism:
      "Believed to stimulate lipolysis and inhibit lipogenesis without binding the GH receptor at meaningful levels.",
    ...
    dosing: "Trial doses typically 250–500 mcg/day subcutaneous in research.",
  ...
  },
  {
    ...
    description:
      "Semax is a synthetic heptapeptide derived from a fragment of adrenocorticotropic hormone (ACTH 4-10). Developed in Russia, it is approved there for stroke and cognitive disorders, and is widely studied for BDNF/NGF-related effects.",
    mechanism:
      "Increases expression of BDNF and NGF; modulates dopaminergic and serotonergic systems; appears to influence enkephalinase activity.",
    ...
    dosing: "Intranasal in research, typically 100–600 mcg total daily.",
  ...
  },
  {
    ...
    description:
      "Selank is a synthetic heptapeptide based on the immunomodulatory tetrapeptide tuftsin. It was developed alongside Semax and has been studied in Russia for generalized anxiety disorder, with reported absence of sedation or dependence.",
    mechanism:
      "Modulates serotonergic and GABAergic systems; reported effects on enkephalinase activity and cytokine balance.",
    ...
    dosing: "Intranasal 250–900 mcg total daily in research literature.",
    status: "Approved in Russia; not approved in the US/EU.",
  ...
  },
  {
    ...
    description:
      "Cerebrolysin is a complex of low-molecular-weight neuropeptides and free amino acids derived from porcine brain. It has been used for decades in parts of Europe and Asia for ischemic stroke, traumatic brain injury, and Alzheimer's disease, with mixed clinical-trial results.",
    mechanism:
      "Believed to mimic neurotrophic factor activity, supporting neuronal survival, synaptogenesis, and neuroplasticity.",
    ...
    dosing: "Clinical use elsewhere: 5–30 mL IV per day for 10–20 day cycles.",
  ...
  },
  {
    ...
    mechanism:
      "Believed to potentiate hepatocyte growth factor (HGF) / c-Met signaling, supporting dendritic spine formation.",
    ...
    dosing: "Animal studies use mg/kg oral dosing; no human protocol exists.",
  ...
  },
  {
    ...
    mechanism:
      "Reportedly upregulates telomerase activity in some cell lines; modulates pineal-gland-related hormone rhythms.",
    ...
    dosing: "Russian protocols cite 5–10 mg subcutaneous daily for short cycles.",
    status: "Not FDA-approved.",
  ...
  },
  {
    ...
    mechanism:
      "Activates AMPK signaling and modulates folate–methionine cycling; appears to translocate to the nucleus under stress.",
    ...
    dosing: "Animal studies use mg/kg-range injections; no validated human protocol.",
  ...
  },
  {
    ...
    mechanism:
      "Binds cardiolipin, stabilizing electron-transport-chain supercomplexes and reducing reactive-oxygen-species production.",
    ...
    dosing: "Clinical trials commonly use 40 mg subcutaneously daily.",
  ...
  },
  {
    ...
    description:
      "Thymosin Alpha-1 is a 28-amino-acid peptide produced by the thymus, with broad immunomodulatory activity. It is approved in numerous countries (as Zadaxin) for chronic hepatitis B and C and as an adjuvant in oncology and infectious disease.",
    mechanism:
      "Activates Toll-like receptor 9 on dendritic cells and modulates T-cell maturation; influences cytokine balance toward Th1.",
    ...
    dosing: "Typical clinical use: 1.6 mg subcutaneously twice weekly.",
  ...
  },
  {
    ...
    description:
      "LL-37 is the only human cathelicidin, a 37-amino-acid antimicrobial peptide expressed by epithelial and immune cells. It has roles in pathogen defense, wound healing, and immune modulation, and is being explored as a therapeutic.",
    mechanism:
      "Disrupts microbial membranes; binds LPS; modulates chemokine signaling and angiogenesis.",
    ...
    dosing: "Investigational; no validated human dose.",
  ...
  },
  {
    ...
    mechanism:
      "Agonist at melanocortin receptors (MC4R primarily) in the central nervous system, influencing sexual arousal pathways.",
    ...
    dosing: "Vyleesi: 1.75 mg subcutaneous, as-needed prior to anticipated activity.",
  ...
  },
  {
    ...
    description:
      "Melanotan II is a synthetic analog of α-MSH that activates melanocortin receptors, producing eumelanin synthesis (tanning) and arousal effects. It is sold widely as a research chemical despite serious safety warnings from regulators.",
    mechanism:
      "Non-selective melanocortin receptor agonist (MC1R for pigmentation; MC4R for arousal).",
    ...
    dosing: "Research-market dosing varies; not validated for human use.",
  ...
  },
  {
    ...
    description:
      "Kisspeptin is a peptide encoded by the KISS1 gene that potently stimulates gonadotropin-releasing hormone (GnRH) neurons, sitting at the top of the reproductive axis. It is being investigated for HSDD, infertility, and as a diagnostic stimulus.",
    mechanism:
      "Binds KISS1R (GPR54) on GnRH neurons, triggering LH/FSH release downstream.",
    ...
    dosing: "Research infusions and bolus dosing in clinical studies; no validated home use.",
    status: "Investigational.",
...
<svg viewBox="0 0 110 160" width="${w}" height="${h}" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  <!-- cap -->
  <rect x="38" y="6" width="34" height="10" rx="2" fill="url(#cap-${p.name})"/>
  <rect x="34" y="14" width="42" height="14" rx="3" fill="url(#cap-${p.name})"/>
  <rect x="36" y="16" width="38" height="2" fill="rgba(0,0,0,0.25)"/>
  <rect x="36" y="20" width="38" height="2" fill="rgba(0,0,0,0.25)"/>

  <!-- bottle body (glass) -->
  <rect x="28" y="28" width="54" height="118" rx="6" fill="url(#glass-${p.name})" stroke="rgba(255,255,255,0.25)" stroke-width="1"/>

  <!-- liquid -->
  <rect x="31" y="60" width="48" height="83" rx="4" fill="url(#liq-${p.name})"/>
  <rect x="31" y="60" width="48" height="3" fill="rgba(255,255,255,0.35)"/>

  <!-- label -->
  <rect x="24" y="78" width="62" height="48" rx="3" fill="url(#label-${p.name})" stroke="rgba(0,0,0,0.15)"/>
...
function renderDetail() {
  ...
  if (!root) return;
  const p = JSON.parse(localStorage.getItem("selectedPeptide"));
  if (!p) {
  ...
  root.innerHTML = `
    ...
    <section class="section">
      <h2>Dosing context (research literature)</h2>
      <p>${p.dosing}</p>
      <p class="warn">This is informational only and not medical advice. Many compounds discussed here are not approved for human use and carry unknown risks.</p>
    </section>
